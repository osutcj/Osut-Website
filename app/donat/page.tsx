            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                <div className="text-center mb-24 px-6">
                    ...
                    >
                        ...
                        <h2 className="text-2xl md:text-5xl font-mono font-bold tracking-[0.1em] text-white break-all mb-4 translate-z-0">
                           {iban}
                        </h2>
                ...
                <div className="w-full max-w-5xl relative flex justify-center items-center mb-10 mx-auto">
                    <div className="absolute w-full h-[2px] bg-gradient-to-r from-transparent via-red-600 to-transparent top-1/2 -translate-y-1/2 opacity-100"></div>
                    <h2 className="bg-[#121212] px-10 text-4xl md:text-5xl font-bold relative z-10 tracking-wide text-white text-center uppercase">
                ...
                <div className="mb-20">
                    <div className="w-full max-w-5xl relative flex justify-center items-center mb-12 mx-auto">
                        <div className="absolute w-full h-[2px] bg-gradient-to-r from-transparent via-red-600 to-transparent top-1/2 -translate-y-1/2 opacity-100"></div>
                        <h2 className="bg-[#121212] px-10 text-3xl md:text-4xl font-bold relative z-10 tracking-wide text-white text-center uppercase">
