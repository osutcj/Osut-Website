...
const images = [
  "/assets/images/images/voluntari/1.webp",
  "/assets/images/images/voluntari/2.webp",
  "/assets/images/images/voluntari/3.webp",
  "/assets/images/images/voluntari/4.webp",
  "/assets/images/images/voluntari/5.webp",
  "/assets/images/images/voluntari/6.webp",
  "/assets/images/images/voluntari/7.webp",
];

export default function VoluntariCarousel() {
  return (
          ...
          {images.map((src, idx) => (
            <SwiperSlide key={idx}>
              <div className="relative w-full h-full">
                <Image
                  src={src}
                  alt={`Experiența de voluntar - ${idx + 1}`}
                  fill
